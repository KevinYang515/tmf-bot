...
> 最後更新：2026-07-04（overnight research pass 兩輪：§3.1 門檻/動態TP、§3.2 多空不對稱等新因子）
...
| 因子 | 觀察 | 為何不部署 |
|---|---|---|
| 星期幾效應（0845/1500 都測） | 數字亂跳（1500週二 PF=inf n=4、週三 PF=0 n=2） | 每個 weekday bucket 只有 2~7 筆，純雜訊 |
